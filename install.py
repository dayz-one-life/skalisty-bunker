...
def get_mission_path():
    path = input("Enter the full path to your DayZ mission directory (e.g., C:\\DayZServer\\mpmissions\\dayzOffline.chernarusplus): ").strip()
...
def install_custom_files(mission_path):
    ...
    files_to_copy = ["skalisty-bunker.json", "skalisty-bunker-pra.json"]
...
def main():
    print("=== Skalisty Bunker Install Script ===")
